(function() {
    function initForm() {
        ...
        let selectedContentType = document.querySelector('.type-btn.active')?.id === 'fileTypeBtn' ? 'file' : 
                                  document.querySelector('.type-btn.active')?.id === 'linkTypeBtn' ? 'link' : 'text';
        ...
        if (urlInput) {
            urlInput.addEventListener('input', function() { updatePreview(this.value); });
        }
        ...
        if (form) {
            ...
            form.addEventListener('submit', function(e) {
                // Update contentType hidden field
                let contentTypeInput = document.querySelector('input[name="contentType"]');
                if (!contentTypeInput) {
                ...
                contentTypeInput.value = selectedContentType;
                
                // Update title and description are already bound
            });
        }
    }
